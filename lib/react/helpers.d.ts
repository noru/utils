...
declare type ProxyHandler = <CustomParams extends any[]>(origin: React.EventHandler<React.SyntheticEvent>) => (...args: CustomParams) => void;
export declare function overrideEventhandler<T extends keyof GlobalEventHandlersEventMap>(child: React.ReactChild, eventName: T, deligator: ProxyHandler): string | number | React.ReactElement<ReactAttributes, string | ((props: any) => React.ReactElement<any, string | any | (new (props: any) => React.Component<any, any, any>)> | null) | (new (props: any) => React.Component<any, any, any>)>;
export {};
