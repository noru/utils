...
export { isArray, isNullOrEmpty, deepMap, shallowEqual, swap, pick, isMobile, identity, noop, apply, Try, isNumber, toPercentage, isBetween, isPremitive, recursiveCopy, isEqual, merge, random, randomInt, ellipsis, parseQuery, actualBgColor, toggleFullscreen, isFullscreen, requestFullscreen, exitFullscreen };
