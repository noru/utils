...
describe('ObjectUtil', () => {
  it('shallowEqual', () => {
    expect(ObjectUtil.shallowEqual([], [])).to.be.true
    expect(ObjectUtil.shallowEqual([1, 2, 3], [1, 2, 3])).to.be.true

    expect(ObjectUtil.shallowEqual([1], [])).to.be.false
    expect(ObjectUtil.shallowEqual([{}], [{}])).to.be.false

    expect(ObjectUtil.shallowEqual({}, {})).to.be.true
    expect(ObjectUtil.shallowEqual({ a: 1 }, { a: 1 })).to.be.true
    expect(ObjectUtil.shallowEqual({ a: 1 }, { a: 2 })).to.be.false
    expect(ObjectUtil.shallowEqual({ a: 1, b: {} }, { a: 1, b: {} })).to.be.false
  })
